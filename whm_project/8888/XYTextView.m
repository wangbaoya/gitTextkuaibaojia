...
//        _countNumLabel.text = [NSString stringWithFormat:@"0/%ld",getLimitNum] ;
...
//    
//    NSInteger wordCount = self.text.length<1?0:self.text.length;
//    
//    if(![self wordLimit:wordCount]) return;
//    
//    self.countNumLabel.text = [NSString stringWithFormat:@"%ld/%ld",self.text.length<1?0:self.text.length,getLimitNum];
//    
