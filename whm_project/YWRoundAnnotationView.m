...
-(void)initWithContentViews{
    ...
    layer.path=[ UIBezierPath bezierPathWithRoundedRect:view.frame cornerRadius:30].CGPath;
//    layer.fillColor=[UIColor colorWithRed:83/255.0 green:180/255.0 blue:119/255.0 alpha:1.0].CGColor;
   ...
   [view.layer addSublayer:layer];
    ...
    UILabel *lable=[[ UILabel alloc] initWithFrame:CGRectMake(0,3, 60, 25)];
    ...
    UILabel *countlable=[[ UILabel alloc] initWithFrame:CGRectMake(0,30, 60, 25)];
    countlable.textAlignment=NSTextAlignmentCenter;
    countlable.textColor=[ UIColor orangeColor];
    countlable.font=[UIFont fontWithName:@"Helvetica-Bold" size:15];
    countlable.text=@"50";
        ...
        if (selected)
        {
            if (_CalloutView == nil)
            {
               ...
               _CalloutView.center = CGPointMake(CGRectGetWidth(_contentView. bounds) / 2.f + self.calloutOffset.x,-CGRectGetHeight(_CalloutView.bounds) / 2.f + self.calloutOffset.y);
                ...
                [_btn setTitle:@"123" forState:UIControlStateNormal];
...
//     CGFloat Width = [titleText sizeWithFont:[UIFont systemFontOfSize: 13] constrainedToSize:CGSizeMake(CGFLOAT_MAX, 21) lineBreakMode:NSLineBreakByWordWrapping].width;
    ...
    CGFloat Width = [WBYRequest getWeightForString:titleText withHeight:21 withFontSize:13];
