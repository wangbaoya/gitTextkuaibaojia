//
//  AAxinyiyuandituViewController.m
//  whm_project
//
...
@interface AAxinyiyuandituViewController ()<BMKMapViewDelegate,BMKLocationServiceDelegate>
{
...
@implementation AAxinyiyuandituViewController
...
- (void)mapView:(BMKMapView *)mapView regionDidChangeAnimated:(BOOL)animated
{
    ...
    {
        juliDistance = 7;
    }else if (mapView.zoomLevel>14&&mapView.zoomLevel<16)
    {
...
-(void)requestdata:(NSString*)str
{
    ...
    [WBYRequest wbyPostRequestDataUrl:@"hos_count" addParameters:dic success:^(WBYReqModel *model) {
...
-(void)addsecond
{
    for (DataModel * mod in bigArray)
    {
        ...
        [dic setObject:mod.name?mod.name:@"暂无" forKey:@"name"];
        ...
        [dic setObject:mod.img?mod.img:@"暂无" forKey:@"img"];

        
        [dic setObject:mod.level?mod.level:@"暂无" forKey:@"level"];
        [dic setObject:mod.autho?mod.autho:@"暂无" forKey:@"autho"];
        [dic setObject:mod.nature?mod.nature:@"暂无" forKey:@"nature"];
        [dic setObject:mod.desi?mod.desi:@"暂无" forKey:@"desi"];
        [dic setObject:mod.info?mod.info:@"暂无" forKey:@"info"];
        [dic setObject:mod.depa?mod.depa:@"暂无" forKey:@"depa"];
        [dic setObject:mod.guide?mod.guide:@"暂无" forKey:@"guide"];
        
        ComModel * com = [mod.com firstObject];

        [dic setObject:com.cname?com.cname:@"暂无" forKey:@"cname"];
...
- (void)mapView:(BMKMapView *)mapView didSelectAnnotationView:(BMKAnnotationView *)view
{
    ...
    else if ([view isKindOfClass:[AAwbyZiDingYiView class]])
    {
        ...
        [imgBut sd_setImageWithURL:[NSURL URLWithString:model.img] forState:UIControlStateNormal placeholderImage:[UIImage imageNamed:@"city"]];
...
//    NSMutableDictionary * dic = [NSMutableDictionary dictionary];
//    
//    [dic setObject:myid?myid:@"" forKey:@"hos_id"];
//    
//    [WBYRequest wbyPostRequestDataUrl:@"get_hos_detail" addParameters:dic success:^(WBYReqModel *model)
//    {
//        
//        if ([model.err isEqualToString:TURE])
//        {
//            
            AAyiyuanxiangqingViewController * wby = [AAyiyuanxiangqingViewController new];
               wby.myDataModel = mymodel;
       wby.gongsimingzi = 666;
